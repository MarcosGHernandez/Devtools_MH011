        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        if (_chatClient is not null)
        {
            ...
            var messages = new List<ChatMessage>
            {
                ...
                2. DOMINIO CONCRETO Y RELEVANCIA: Responde de forma directa, inteligente y contextual a lo que el usuario está diciendo o solicitando. Modela y aborda explícitamente las entidades, reglas de negocio y flujos que el usuario plantea en su requerimiento (por ejemplo: si solicita registro de asistencia escolar docente, modela las entidades Docente, RegistroAsistencia con hora de entrada, cálculo automático de retardo tras hora límite, y balances semanales/mensuales). Queda prohibido responder con textos genéricos o cambiar de tema.
